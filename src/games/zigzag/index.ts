...
export const zigzag: GamePackage<Zig, ZigState> = {
  meta: {
    ...
    rules: [
      ...
      'The numbers you cross have to follow the run shown under the board — 1, 2, 3, 4, then 1 again — all the way. The next number wanted is lit, and so are the cells the line can step into.',
      'Drag back over the cell before to take a step off, or press any cell the line runs through to cut it back to there and carry on.',
    ],
  },
  puzzles: () => puzzles,
  /*
